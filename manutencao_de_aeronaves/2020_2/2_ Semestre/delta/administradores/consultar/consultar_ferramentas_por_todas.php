  ...
  .modal-content {
    width: 100%;
          ...
          <body>
               ...
               <thead>
               <tr>
          <th class="table-info"><font color="black"><center>NOME</center></th>
					<th class="table-info"><font color="black"><center>PART NUMBER</center></th>
					<th class="table-info"><font color="black"><center>QUANTIDADE</center></th>
					<th class="table-info"><font color="black"><center>DESCRIÇÃO</center></th>
					<th class="table-info"><font color="black"><center>DEPARTAMENTO</center></th>
					<th class="table-info"><font color="black"><center>IMAGEM</center></th>
               </tr>
