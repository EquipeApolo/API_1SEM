...
<?php
           ...
           else
           {
                ...
                $consulta_clientes = mysqli_query($link, "SELECT * FROM $table_administradores WHERE cpf = '$cpf'");
...
<?php
                         ...
                         $inserir_logins = mysqli_query($link, "INSERT INTO $table_logins(nickname,email,senha,status) VALUE ('$nickname','$email','$senha',1)");
...
<?php
                         ...
                         else
                         {
                              ...
                              $inserir_administradores = mysqli_query($link, "INSERT INTO $table_administradores (nome,sobrenome,nascimento,sexo,telefone,
                              celular,cpf,codigo_login,rua,numero,bairro,cep,cidade,estado) VALUES ('$nome','$sobrenome','$nasc','$sexo','$telefone','$celular','$cpf',$vetor[0],'$rua',$numero,'$bairro',$cep,'$cidade','$estado')");
...
?>
                                   ...
                                   <script language="JavaScript">
                                        alert("Erro ao cadastrar o ADMINISTRADOR. Entre em contato com o desenvolvedor do sistema");
                                        history.go(-1);
                                   </script>
<?php
                              }
