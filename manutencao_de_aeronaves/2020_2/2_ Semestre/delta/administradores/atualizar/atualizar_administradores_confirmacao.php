...
<?php
     ...
     $cpf1 = substr($vetor_administrador['cpf'],0,3);
     $cpf2 = substr($vetor_administrador['cpf'],3,3);
     $cpf3 = substr($vetor_administrador['cpf'],6,3);
     $cpf4 = substr($vetor_administrador['cpf'],9,3);

     //desconcatenando telefone

     $telefone1 = substr($vetor_administrador['telefone'],0,2);
     $telefone2 = substr($vetor_administrador['telefone'],2,4);
     $telefone3 = substr($vetor_administrador['telefone'],6,4);

     //desconcatenando celular

     $celular1 = substr($vetor_administrador['celular'],0,2);
     $celular2 = substr($vetor_administrador['celular'],2,5);
     $celular3 = substr($vetor_administrador['celular'],7,4);
?>
<html>
      <head>
	  <meta charset="utf-8">
...
<body>
      <form name="f" action="atualizar_administradores_confirmacao2.php" method="post">

       DADOS PARA A ATUALIZAÇÃO DE ADMINISTRADOR NO SISTEMA:<br><br>
      ...
      (*)NOME: <input type="text" name="c_nome" value="<?php print($vetor_administrador["nome"]);?>"><br>
      (*)SOBRENOME: <input type="text" name="c_sobrenome" value="<?php print($vetor_administrador["sobrenome"]);?>"><br>
      (*)SEXO: <select name="c_sexo"><br>
	  <option value="<?php print($vetor_administrador["sexo"]);?>"><?php print($vetor_administrador['sexo']);?></option>
      <option value="MASCULINO">MASCULINO</option>
      <option value="FEMININO">FEMININO</option>
      </select><br>
      (*)DATA DE NASCIMENTO:<input type="date" name="c_nasc" max="<?php echo date('Y-m-d');?>" value="<?php print($vetor_administrador["nascimento"]);?>"><br>
      ...
      <form method="get" action=".">
        <label>(*)CEP:
        <input name="c_cep" type="text" id="cep" size="8" maxlength="8" onKeyUp="cepcompleto();" value="<?php print($vetor_administrador["cep"]);?>" /><br>
        <label>(*)RUA:
        <input name="c_rua" type="text" id="rua" size="60" readonly="true" value="<?php print($vetor_administrador["rua"]);?>"><br>
        <label>(*)BAIRRO:
        <input name="c_bairro" type="text" id="bairro" size="40" readonly="true" value="<?php print($vetor_administrador["bairro"]);?>"><br>
        (*)CIDADE:
        <input name="c_cidade" type="text" id="cidade" size="40" readonly="true" value="<?php print($vetor_administrador["cidade"]);?>"><br>
        (*)ESTADO:
        <input name="c_uf" type="text" id="uf" size="2" value="<?php print($vetor_administrador["estado"]);?>"><br>
      </form>
      (*)NÚMERO: <input type="text" name="c_numero" size="4" maxlength="8" value="<?php print($vetor_administrador["numero"]);?>"><br><br>
