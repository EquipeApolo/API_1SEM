...
?>
          ...
          <body>
               ...
               <tr>
					...
					<td align="center"><font color="black"><h2>ATUALIZAR</h2></td>
               </tr>
<?php
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="atualizar_departamentos2.php?codigo_departamento=<?php print($vetor_departamentos['codigo']);?>">Clique Aqui</a></td>
               </tr>
<?php
                    }
?>
