...
?>
          ...
          <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
                    <title>Todos departamento</title>
          ...
          <body>
               ...
               <tr>
					...
					<td align="center"><font color="black"><h2>EXCLUIR</h2></td>
               </tr>
<?php
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="excluir_departamentos2.php?codigo_departamento=<?php print($vetor_departamentos['codigo']);?>">Clique Aqui</a></td>
               </tr>
<?php
                    }
?>
               </table><br>
               <center><a href="excluir.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
     }
?>
