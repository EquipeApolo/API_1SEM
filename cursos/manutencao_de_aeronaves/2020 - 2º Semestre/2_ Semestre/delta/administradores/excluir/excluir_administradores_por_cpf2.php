...
?>
               <script language="JavaScript">
                    ...
                    document.location.href="excluir_administradores_por_cpf.php";
               </script>
<?php
          }
          else if(empty($cpf2))
...
<?php
          ...
          else
          {
               ...
               //Realizando consultas necessarioas
                    ...
                    $consultar_administradores = "SELECT * FROM $table_administradores WHERE cpf = '$cpf'";
                    $resultado_consultar_administradores = mysqli_query($link, $consultar_administradores);
                    $quant_administradores = mysqli_num_rows($resultado_consultar_administradores);
                     if($quant_administradores == 0)
                     {
?>
                          <script language="JavaScript">
...
?>
          ...
          <body>
				...
				<center><h1> Visualizar administrador por CPF</h1></center>
...
<?php
                    ...
                    {
                         $vetor_administradores = mysqli_fetch_array($resultado_consultar_administradores);
...
?>
               <tr>
					...
					<td align="center"><font color="black"><a href="excluir_administradores_confirmacao.php?codigo_login=<?php print($vetor_logins['codigo']);?>&codigo_administrador=<?php print($vetor_administradores['codigo']);?>">Clique Aqui</a>
               </tr>
<?php
                    }
?>
               </table><br>
               <center><a href="excluir_administradores_por_cpf.php"><input type="button" name="botao" value="VOLTAR"></a></center>
<?php
		}
     }
}
