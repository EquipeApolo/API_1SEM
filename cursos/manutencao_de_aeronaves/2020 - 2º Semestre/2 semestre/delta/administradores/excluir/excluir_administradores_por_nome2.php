...
?>
               <script language="JavaScript">
                    ...
                    document.location.href="excluir_administradores_por_nome.php";
               </script>
<?php
          }
          else
...
?>
               ...
               <center><a href="excluir_administradores_por_nome.php"><input type="button" name="botao" value="VOLTAR"></a></center>
               </body>
               </html>
<?php
               }
